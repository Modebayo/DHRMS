...
app.post('/api/auth/exchange', authRoutes.exchangeToken);
app.post('/api/auth/admin-create', authMiddleware, requireRole('admin', 'administrator'), authRoutes.adminCreateUser);
